...
restart = createSprite(400,300,100,50)
restart.addImage("restartbutton", restartImg)
  ...
  spaceship.scale=0.5;
  spaceship.setCollider("rectangle",0,0,100,60)
...
function spawnAlienShip() {
  //write code here to spawn the clouds
   if (frameCount % 200 === 0) {
     ...
     alien.setCollider("rectangle",0,0,100,50)
...
function spawnStars() {
  //write code here to spawn the clouds
   if (frameCount % 300 === 0) {
     ...
     star.scale = 0.2;
     star.velocityY = 2;
     star.setCollider("rectangle",0,0,40,20)
